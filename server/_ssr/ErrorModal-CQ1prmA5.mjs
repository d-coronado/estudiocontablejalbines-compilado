...
import { a as apiGet, d as getSessionUser, i as apiDelete, l as cn, m as onAuthChange, n as Button, o as apiPost, p as logout, r as Input, s as apiPut, t as BrandLogo, u as getCurrentUserInfo } from "./auth-CNcD96W4.mjs";
import { g as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { S as Check, a as ShieldCheck, b as ChevronRight, d as LogOut, f as LoaderCircle, n as Users, r as TriangleAlert, t as X, u as PanelLeft, y as Circle } from "../_libs/lucide-react.mjs";
import { t as Root } from "../_libs/radix-ui__react-separator.mjs";
import { a as Portal, i as Overlay, n as Content, o as Root$1, r as Description, s as Title, t as Close } from "../_libs/@radix-ui/react-dialog+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ErrorModal-CQ1prmA5.js
...
function AppSidebar() {
	...
	const initials = (info?.username ?? "U").slice(0, 2).toUpperCase();
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarHeader, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-gold text-gold-foreground shadow-sm",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandLogo, { className: "h-6 w-6" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "min-w-0 flex-1 group-data-[collapsible=icon]:hidden",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "truncate font-display text-[15px] font-semibold leading-tight text-sidebar-foreground",
							children: "ECJA"
						})
					})]
				})
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarContent, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarGroup, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupLabel, {
					className: "text-[10px] uppercase tracking-[0.14em] text-sidebar-foreground/50",
					children: "General"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenu, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarMenuButton, {
					isActive: true,
					tooltip: "Clientes",
					className: "h-10 gap-3 rounded-lg data-[active=true]:bg-gold data-[active=true]:text-gold-foreground data-[active=true]:font-semibold data-[active=true]:shadow-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Users, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Clientes" })]
				}) }) }) })] })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				className: "border-t border-sidebar-border p-3",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3 rounded-lg bg-sidebar-accent/40 p-2.5 group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:p-0 group-data-[collapsible=icon]:justify-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "relative grid h-9 w-9 shrink-0 place-items-center rounded-full bg-gold font-display text-sm font-semibold text-gold-foreground",
						children: [initials, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "absolute -bottom-0.5 -right-0.5 grid h-3.5 w-3.5 place-items-center rounded-full bg-emerald-500 ring-2 ring-sidebar",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-2 w-2 text-white" })
						})]
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							className: "truncate text-[10px] uppercase tracking-wider text-sidebar-foreground/50",
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarMenuButton, {
						...
						className: "h-9 gap-3 rounded-lg text-sidebar-foreground/80 hover:bg-destructive/15 hover:text-destructive",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LogOut, { className: "h-4 w-4" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Cerrar sesión" })]
					}) })
				})]
			})
		]
...
function AppShell({ title, subtitle, actions, children }) {
	...
	(0, import_react.useEffect)(() => {
		setState(getSessionUser() ? "in" : "out");
		return onAuthChange((u) => setState(u ? "in" : "out"));
	}, []);
	(0, import_react.useEffect)(() => {
		if (state === "out") navigate({
			to: "/auth",
			replace: true
		});
	}, [state, navigate]);
	if (state !== "in") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarInset, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				className: "sticky top-0 z-30 border-b border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/75",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-3 px-4 py-3 sm:flex sm:h-16 sm:gap-3 sm:px-6 lg:px-8",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarTrigger, { className: "h-9 w-9 shrink-0 text-foreground hover:bg-muted" }),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								className: "truncate font-display text-lg font-semibold leading-tight text-foreground sm:text-xl",
								children: title
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "col-start-3 row-start-1 flex items-center gap-2 sm:contents",
							children: [actions, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserMenu, {})]
						})
					]
				})
...
function UserMenu() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			type: "button",
			className: "ml-1 flex items-center gap-2 rounded-full border border-border bg-card p-0.5 pr-2.5 transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
			"aria-label": "Menú de usuario",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "grid h-8 w-8 place-items-center rounded-full bg-navy font-display text-xs font-semibold text-navy-foreground",
				children: (info?.username ?? "U").slice(0, 2).toUpperCase()
...
async function listClientsPaged(query) {
	const params = new URLSearchParams();
	if (query.search) params.set("q", query.search);
	params.set("page", String(query.page - 1));
	params.set("size", String(query.pageSize));
	const spring = await apiGet(`/api/v1/clientes?${params.toString()}`);
	return {
		items: spring.content,
		total: spring.totalElements,
		page: spring.number + 1,
		pageSize: spring.size,
		totalPages: spring.totalPages
	};
}
async function getClient(id) {
	return apiGet(`/api/v1/clientes/${id}`);
}
async function createClient(input) {
	return apiPost("/api/v1/clientes", input);
}
async function updateClient(id, input) {
	const payload = {};
	for (const [key, value] of Object.entries(input)) if (value !== null && value !== void 0) payload[key] = value;
	return apiPut(`/api/v1/clientes/${id}`, payload);
}
async function deleteClient(id) {
	return apiDelete(`/api/v1/clientes/${id}`);
}
async function revealClaveSol(id, password) {
	return (await apiPost(`/api/v1/clientes/${id}/clave-sol`, { password })).claveSol;
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mx-auto mb-2 grid h-12 w-12 place-items-center rounded-full bg-destructive/15 text-destructive",
...
//#endregion
export { revealClaveSol as _, DialogFooter as a, DropdownMenu as c, DropdownMenuTrigger as d, ErrorModal as f, listClientsPaged as g, getClient as h, DialogDescription as i, DropdownMenuContent as l, deleteClient as m, Dialog as n, DialogHeader as o, createClient as p, DialogContent as r, DialogTitle as s, AppShell as t, DropdownMenuItem as u, updateClient as v };
